    ...
    <>
      <div className="border border-zinc-200 dark:border-zinc-800 rounded-lg bg-white dark:bg-zinc-900">
        ...
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2.5 text-left hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition rounded-lg"
        >
          ...
          {dateStr && <span className="text-xs text-zinc-400 shrink-0">{dateStr}</span>}
        </button>

        {/* Expanded content */}
        {expanded && (
          <div className="px-3 pb-3 space-y-3 border-t border-zinc-200 dark:border-zinc-800 pt-3 mt-0">
            {/* Question */}
            <div>
              ...
              <div className="text-sm text-zinc-800 dark:text-zinc-200">{item.question.zh}</div>
            </div>
            <div>
              <div className="text-xs font-medium text-zinc-500 mb-1 flex items-center gap-2">
              ...
              <div className="text-sm text-zinc-800 dark:text-zinc-200">{item.question.en}</div>
            </div>
            {/* Answer */}
            <div>
              <div className="text-xs font-medium text-zinc-500 mb-1">{t.bank.answerZh}</div>
              <div className="text-sm text-zinc-800 dark:text-zinc-200 whitespace-pre-wrap">{item.answer.zh}</div>
            </div>
            <div>
              <div className="text-xs font-medium text-zinc-500 mb-1">{t.bank.answerEn}</div>
              <div className="text-sm text-zinc-800 dark:text-zinc-200 whitespace-pre-wrap">{item.answer.en}</div>
            </div>
