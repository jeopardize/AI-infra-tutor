        ...
        {expanded && (
          <div className="px-3 pb-3 space-y-3 border-t border-zinc-200 dark:border-zinc-800 pt-3 mt-0 overflow-hidden">
            ...
            <div className="min-w-0">
              ...
              <div className="text-sm text-zinc-800 dark:text-zinc-200 break-words overflow-hidden">{item.question.en}</div>
            </div>
            {/* Answer */}
            <div className="min-w-0">
              <div className="text-xs font-medium text-zinc-500 mb-1">{t.bank.answerZh}</div>
              <div className="text-sm text-zinc-800 dark:text-zinc-200 whitespace-pre-wrap break-words overflow-hidden">{item.answer.zh}</div>
            </div>
            <div className="min-w-0">
